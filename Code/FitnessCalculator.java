...
public class FitnessCalculator {
    ...
    int popsize = 200; //max population
    double mutation = 0.01; //1% mutation rate
    int[] population;
    ...
    public static void main(String[] args) {
        ...
        /*System.out.println("The fitness of document1-shredded.txt is " + fitness(shreddedDocument, Chromosome));
        ...
        /*shreddedDocument = getShreddedDocument("src/document1-shredded.txt");
        //int[] perm1 = {0,1,2,3,4,5,6,7};
        System.out.println("The fitness of SillyExample-shredded.txt is: " +fitness(shreddedDocument, Chromosome));
        System.out.println("Here is what the shredded document looks like");
        prettyPrint(shreddedDocument);*/
